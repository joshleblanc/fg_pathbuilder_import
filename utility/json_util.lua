-- use import and then JSONUtil.parse(json string)
local json = {}
...
nullTable = {}  -- This is a one-off table to represent the null value.
...
function parse(str, pos, end_delim)
  ...
  elseif first == end_delim then  -- End of an object or array.
    ...
    local literals = {['true'] = true, ['false'] = false, ['null'] = nullTable}
...
function unescape(str)
  return (string.gsub( str:gsub("<p>", ""):gsub("</p>",""), '(&(#?x?)([%d%a]+);)', entitySwap ))
end
